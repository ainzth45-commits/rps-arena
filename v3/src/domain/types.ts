...
export interface PrivacyCurtain {
  reason: "moveset" | "offround";
  playerId?: string;
}
...
export interface SeasonArchive {
  ...
  ranking: Array<{ rank: number; playerName: string; mainScoreUnits: number; sideScore: number }>;
  revealedMovesets: Array<{ playerName: string; moveset: [Move, Move, Move] | null }>;
}
...
export interface GameState {
  ...
  privacyCurtain: PrivacyCurtain | null;
