...
describe("เรตการออกมูฟ", () => {
  it("คิด % จากจำนวนครั้งทั้งหมด เรียงมากไปน้อย", () => {
  ...
  it("ยังไม่เคยออกมูฟเลย → อาเรย์ว่าง ไม่ใช่ NaN (spec §16 ข้อ 11)", () => {
...
describe("ภาษีของแชมป์ — เปิดเรตมูฟท็อป 3 (spec §12)", () => {
  ...
  it("ติดท็อป 3 แต่ยังไม่เคยออกมูฟ → อาเรย์ว่าง (จอโชว์ 'ยังไม่มีข้อมูล')", () => {
